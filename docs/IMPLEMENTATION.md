...
- Dataset-scoped favorite settlements are persisted in the application settings database and survive restart. Notes, frozen analysis snapshots, named saved searches, and comparisons are not implemented yet.
