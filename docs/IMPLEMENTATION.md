...
- A transient multi-settlement shortlist exists for the current Desktop analysis session, but notebook/favorites, notes, named saved searches, and comparisons are not persisted yet; only the current search/candidate context is restored.
