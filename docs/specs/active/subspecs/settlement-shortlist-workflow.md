...
Active product sub-spec; candidate-source, persistent Favorites, explicit Favorites-to-import re-analysis, notebook notes/frozen snapshots, batch external search, and portable export/share are implemented. Calibration/acceptance remains pending.
