...
data class UiStrings(
    ...
    val snapshotUpdateUnavailable: String,
...
private val RussianUiStrings = UiStrings(
    ...
    editFavoriteNote = "Изменить заметку",
    ...
    updateFavoriteSnapshot = "Обновить снимок анализа",
    snapshotUpdateUnavailable = "Для обновления снимка населённый пункт должен входить в текущие результаты.",
...
private val EnglishUiStrings = UiStrings(
    ...
    updateFavoriteSnapshot = "Update analysis snapshot",
    snapshotUpdateUnavailable = "The settlement must be in the current ranked results to update its snapshot.",
