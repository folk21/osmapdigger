...
/**
 * Desktop fallback used when MapLibre Compose has no native JNI runtime for the host.
 *
 * The fallback is intentionally non-fatal: analytical search, filtering, settlement details,
 * and external property search remain fully available. This is currently expected on Intel
 * macOS, for which MapLibre Compose 0.13.x publishes no `macos-amd64` native capability.
 */
@Composable
