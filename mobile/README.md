...
| `analysis` | Preference scoring, candidate-scope contract, contributions, ranked-analysis orchestration | `domain`, `search`, `dataset` | `SettlementCandidateScope`, `PreferenceScorer`, `SettlementRanker`, `SettlementAnalysisService` |
