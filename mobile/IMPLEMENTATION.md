...
- dataset-scoped Favorites are persisted and browseable on Desktop; notes, frozen analysis snapshots, named saved searches, and comparison state are not implemented yet.
